...
const migrations = readFileSync(new URL('../supabase/migrations/007_phase4_1_commercial_qa_hardening.sql', import.meta.url), 'utf8')
...
const roleMatrix: Record<RoleName, Record<string, boolean>> = {
  owner: { view: true, create: true, edit: true, submit: true, approve: true, lockLayer1: true, readyForLayer2: true, importBaseline: true, lockBaseline: true, audit: true },
  admin: { view: true, create: true, edit: true, submit: true, approve: true, lockLayer1: true, readyForLayer2: true, importBaseline: true, lockBaseline: true, audit: true },
  finance_admin: { view: true, create: false, edit: false, submit: false, approve: true, lockLayer1: true, readyForLayer2: true, importBaseline: true, lockBaseline: true, audit: true },
  planner: { view: true, create: true, edit: true, submit: true, approve: false, lockLayer1: false, readyForLayer2: false, importBaseline: true, lockBaseline: false, audit: false },
  reviewer: { view: true, create: false, edit: false, submit: false, approve: true, lockLayer1: false, readyForLayer2: false, importBaseline: false, lockBaseline: false, audit: false },
  viewer: { view: true, create: false, edit: false, submit: false, approve: false, lockLayer1: false, readyForLayer2: false, importBaseline: false, lockBaseline: false, audit: false },
  auditor: { view: true, create: false, edit: false, submit: false, approve: false, lockLayer1: false, readyForLayer2: false, importBaseline: false, lockBaseline: false, audit: true },
  integration_admin: { view: true, create: false, edit: false, submit: false, approve: false, lockLayer1: false, readyForLayer2: false, importBaseline: false, lockBaseline: false, audit: false },
  ai_admin: { view: true, create: false, edit: false, submit: false, approve: false, lockLayer1: false, readyForLayer2: false, importBaseline: false, lockBaseline: false, audit: false }
};

test('commercial role matrix is explicit for governed Phase 1 to Phase 4 actions', () => {
...
test('Layer 1 and baseline repositories scope data access by organisation_id', () => {
  for (const source of [layer1Repository, baselineRepository]) {
