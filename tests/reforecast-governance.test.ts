...
test('Phase 6 stays inside the phase boundary: no actuals, variance, waterfall or AI database objects', () => {
  ...
  for (const forbidden of ['actual', 'variance', 'waterfall', '_ai', 'ai_advisory']) {
...
test('Phase 6 stays inside the phase boundary: actuals, variance, waterfall and AI pages remain placeholders', () => {
  for (const file of ['app/actuals/page.tsx', 'app/variance/page.tsx', 'app/waterfall/page.tsx', 'app/ai/page.tsx']) {
